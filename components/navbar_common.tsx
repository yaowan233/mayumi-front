    ...
    return (
        <div className="relative" ref={menuRef}>
            <button
                ...
                aria-expanded={open}
                className="relative z-[60] flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-zinc-200 bg-white p-0.5 shadow-sm transition-all duration-150 hover:scale-105 hover:border-primary/60 hover:shadow-primary/20 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 dark:border-zinc-700 dark:bg-zinc-950 dark:hover:border-primary/70"
                onPointerDown={(event) => {
            ...
            {open && (
                <div className="absolute right-0 top-12 z-[70] w-56 overflow-hidden rounded-xl border border-zinc-200 bg-white/95 py-2 text-sm text-zinc-900 shadow-2xl backdrop-blur-md dark:border-white/[0.08] dark:bg-zinc-950/95 dark:text-zinc-100">
