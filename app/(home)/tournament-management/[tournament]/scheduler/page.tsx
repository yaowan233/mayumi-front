                                                ...
                                                (
                                                    <div className="flex flex-col gap-5">
                                                        ...
                                                        <div className={"flex flex-row gap-5 items-baseline"}>
                                                            ...
                                                            />
                                                            <Input type="date" label="日期" isRequired
                                                                   isInvalid={!!errMsg && !schedule.match_time}
                                                                   value={schedule.match_time ? (new Date(schedule.match_time)).toISOString().split('T')[0] : ""}
                                                                   onChange={
                                                                       (e) => {
                                                                           let newScheduleInfo = [...scheduleInfo];
                                                                           let datetime;
                                                            ...
                                                            />
                                                            <Input type="time" label="时间" isRequired
                                                                   isInvalid={!!errMsg && !schedule.match_time}
                                                                   value={schedule.match_time ? (new Date(schedule.match_time)).toISOString().split('T')[1].substring(0, 5) : ""}
                                                                   onChange={
                                                                       (e) => {
                                                                           let newScheduleInfo = [...scheduleInfo];
                                                                           let datetime;
                                                                ...
                                                                schedule.match_url?.map((url, urlIndex) => {
                                                                    return (
                                                                        <Input key={urlIndex} label="比赛网址" value={url}
                                                                               description="格式为https://osu.ppy.sh/community/matches/xxxxxxx"
                                                                               onChange={(e) => {
                                                                                   let newScheduleInfo = [...scheduleInfo];
                                                            ...
                                                            <div className="flex-col self-start">
                                                                <Button radius={"none"} color="primary" isIconOnly
                                                                        onPress={() => {
                                                                            let newScheduleInfo = [...scheduleInfo];
                                                                            newScheduleInfo[index].match_url?.push("");
                                                                            setScheduleInfo(newScheduleInfo);
                                                                        }}>+</Button>
                                                                <Button radius={"none"} color="danger" isIconOnly
                                                                        onPress={() => {
                                                                            let newScheduleInfo = [...scheduleInfo];
                                                        ...
                                                        <div className="grid grid-cols-2 gap-5">
                                                            <div className={"flex flex-col gap-5"}>
                                                                ...
                                                                <GroupMemberSelect
                                                                    members={members.filter((member) => member.referee)}
                                                                    scheduleInfo={scheduleInfo}
                                                                    setScheduleInfo={setScheduleInfo} role="referee"
                                                                    index={index}/>
                                                            ...
                                                            <div className={"flex flex-col gap-5"}>
                                                                ...
                                                                <GroupMemberSelect
                                                                    members={teams || members.filter((member) => member.player)}
                                                                    scheduleInfo={scheduleInfo}
                                                                    setScheduleInfo={setScheduleInfo} role="participant"
                                                                    index={index}/>
                                                                <div className="flex flex-wrap gap-5">
                                                                    {
                                                    ...
                                                    <div className="flex flex-col gap-5">
                                                        ...
                                                        <div className="flex flex-row gap-5 items-baseline">
                                                            ...
                                                            <MemberSelect
                                                                members={teams || members.filter((member) => member.player)}
                                                                scheduleInfo={scheduleInfo}
                                                                setScheduleInfo={setScheduleInfo} team="team1" index={index}
                                                                errMsg={errMsg}/>
                                                            <MemberSelect
                                                                members={teams || members.filter((member) => member.player)}
                                                                scheduleInfo={scheduleInfo}
                                                                setScheduleInfo={setScheduleInfo} team="team2" index={index}
                                                                errMsg={errMsg}/>
                                                            <Input type="date" label="日期" isRequired
                                                                   isInvalid={!!errMsg && !schedule.match_time}
                                                                   value={schedule.match_time ? (new Date(schedule.match_time)).toISOString().split('T')[0] : ""}
                                                            ...
                                                            <Switch className="min-w-fit"
                                                                    defaultSelected={schedule.is_winner_bracket} onChange={
                                                                (e) => {
                                                                    let newScheduleInfo = [...scheduleInfo];
                                                        ...
                                                        <div className="grid grid-cols-3 gap-5">
                                                            ...
                                                            <div className={"flex flex-col gap-5"}>
                                                                ...
                                                                <GroupMemberSelect
                                                                    members={members.filter((member) => member.streamer)}
                                                                    scheduleInfo={scheduleInfo}
                                                                    setScheduleInfo={setScheduleInfo} role="streamer"
                                                                    index={index}/>
                                                                <div className="flex flex-wrap gap-5">
                                                                    {
                                                            ...
                                                            <div className={"flex flex-col gap-5"}>
                                                                ...
                                                                <GroupMemberSelect
                                                                    members={members.filter((member) => member.commentator)}
                                                                    scheduleInfo={scheduleInfo}
                                                                    setScheduleInfo={setScheduleInfo} role="commentator"
                                                                    index={index}/>
                                                                <div className="flex flex-wrap gap-5">
                                                                    {
...
const GroupMemberSelect = ({members, scheduleInfo, setScheduleInfo, role, index}: {
    members: (Player | Team)[],
    scheduleInfo: Schedule[],
    setScheduleInfo: React.Dispatch<React.SetStateAction<Schedule[]>>,
    role: "referee" | "participant" | "streamer" | "commentator",
    index: number
}) => {
    const [fieldState, setFieldState] = useState<{
        selectedKey: string | null,
